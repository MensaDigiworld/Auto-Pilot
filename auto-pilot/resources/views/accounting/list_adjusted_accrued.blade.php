  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Adjustment Accrued Expense</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item"><a href="#">Accounting</a></li>
              <li class="breadcrumb-item active">Adjustment Accrued Expense</li>
              {{-- <li class="breadcrumb-item"><a href="{{ route('accounting.new_vendor_invoice') }}" class="btn btn-sm btn-primary"><i class="fas fa-plus"></i> Add New</a></li> --}}
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-sm-12 col-lg-2 col-md-2">
                        <div class="form-group">
                          <label for="inputEmail3" class=" col-form-label">Expense</label>
                          <select class="form-control select2" name="">
                            <option>Select</option>
                            <option>2000</option>
                            <option>2022</option>
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>100000</td>
                        <td class="text-center">
                          <a href="" class="btn btn-sm btn-success text-xs"> <i class="fas fa-eye"></i> View</a>
                        </td>
                      </tr>
                    </tbody>
                  </table>
