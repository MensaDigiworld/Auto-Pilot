  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">List of Bank Account</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item"><a href="#">Accounting</a></li>
              <li class="breadcrumb-item active">List of Bank Account</li>
              <li class="breadcrumb-item"><a href="{{ route('accounting.new_bank_account') }}" class="btn btn-sm btn-primary float-right"><i class="fas fa-plus"></i> Add New</a></li>
