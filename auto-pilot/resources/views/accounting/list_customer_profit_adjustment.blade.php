  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Vehicle Profit Adjustment</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item"><a href="#">Accounting</a></li>
              <li class="breadcrumb-item active">Vehicle Profit Adjustment</li>
          ...
          <div class="col-lg-12 col-12">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-lg-6 col-md-6">
                  ...
                  <div class="col-sm-12 col-lg-6 col-md-6">
                    <a href="{{ route('accounting.new_customer_profit_adjust') }}" class="btn btn-sm btn-primary float-right"><i class="fas fa-plus"></i> Add New</a>
                  </div>
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>03/Nov/2022</td>
                        <td>buy</td>
                        <td><a href="" class="btn btn-sm btn-success"> <i class="fas fa-plus"></i> Add</a></td>
