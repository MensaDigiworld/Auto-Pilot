        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Vehicle Loss  Adjustment</li>
          ...
          <div class="col-lg-12 col-12">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-lg-6 col-md-6">
                  ...
                  <div class="col-sm-12 col-lg-6 col-md-6">
                    <a href="{{ route('accounting.new_customer_profit_adjust_under') }}" class="btn btn-sm btn-primary float-right"><i class="fas fa-plus"></i> Add New</a>
                  </div>
