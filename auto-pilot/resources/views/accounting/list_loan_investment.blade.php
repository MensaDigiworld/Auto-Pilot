  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">New Loan/Invenstment & Repayment</h1>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">New Loan/Invenstment & Repayment</li>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="text-center">
                          ...
                          <a href="{{ route('accounting.new_loan_investment') }}" class="btn btn-sm btn-success"><i class="fas fa-plus"></i> New Loan</a>
                          <a href="{{ route('accounting.new_repayment') }}" class="btn btn-sm btn-success"><i class="fas fa-plus"></i> Repayment</a>
                        </td>
