  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Customer Payment List</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-lg-12 col-12">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-lg-6 col-md-6">
                  ...
                  <div class="col-sm-12 col-lg-6 col-md-6">
                    <a href="{{ route('accounting.new_customer_receive_payment') }}" class="btn btn-sm btn-primary float-right"><i class="fas fa-plus"></i> Add New</a>
                  </div>
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>list_refund_customer_payment</td>
                        <td>pending</td>
