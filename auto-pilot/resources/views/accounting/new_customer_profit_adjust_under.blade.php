  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Vehicle Loss Adjustment</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item"><a href="#">Accounting</a></li>
              <li class="breadcrumb-item active"><a href="#">Vehicle Loss Adjustment</a></li>
          ...
          <div class="col-lg-5 col-md-5 col-sm-12">
            <div class="card">
              <div class="card-header bg-success">
                <h3 class="card-title text-lg">Vehicle Loss Adjustment</h3>
              </div>
            ...
            <form action="#" class="form-horizontal" method="POST">
              ...
              <div class="card-body">
                ...
                <div class="form-group row">
                  <label for="inputEmail3" class="col-sm-2 col-form-label"> Adjustment Amount </label>
                  <div class="col-sm-10">
                    <select class="form-control form-control-sm select2" name="">
                      <option>Type Account Name</option>
                      <option>2000</option>
