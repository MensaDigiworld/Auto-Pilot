  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Reg. & Other Payment</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item"><a href="#">Accounting</a></li>
              <li class="breadcrumb-item active"><a href="#">Reg. & Other Payment</a></li>
          ...
          <div class="col-lg-5 col-md-5 col-sm-12">
            <div class="card">
              <div class="card-header bg-success">
                <h3 class="card-title text-lg">Add Reg. & Other Payment</h3>
              </div>
            ...
            <form action="#" class="form-horizontal" method="POST">
              ...
              <div class="card-body">
                ...
                <div class="form-group row">
                  <label for="inputEmail3" class="col-sm-2 col-form-label">Transaction </label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control form-control-sm" id="inputEmail3" placeholder="Sales Registration" value="" name="name" readonly>
                  </div>
                </div>
                <div class="form-group row">
                  <label for="inputEmail3" class="col-sm-2 col-form-label">Vin/Chassis No </label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control form-control-sm" id="inputEmail3" placeholder="ZwR80-025648" value="" name="name" readonly>
                    <div class="text-bold">Chassis Wise Due: <span class="text-danger">140000.00</span></div> 
                  </div>
                </div>
                
                <div class="form-group row">
                  <label for="inputEmail3" class="col-sm-2 col-form-label">Received From(cr) </label>
                  <div class="col-sm-10">
                ...
                <div class="form-group row">
                  <label for="inputEmail3" class="col-sm-2 col-form-label">Post To(dr) </label>
                  <div class="col-sm-10">
                    <select class="form-control select2" name="">
                      <option>Type Account Name</option>
                      <option>2000</option>
