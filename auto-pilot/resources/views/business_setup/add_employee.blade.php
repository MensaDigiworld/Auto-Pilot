        ...
        <div class="row">
          <div class="col-lg-8 col-8">
            ...
            <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" method="post" action="{{route('add-employee.store')}}">
                @csrf
                <div class="card-body">
                  <div class="row">
                      <div class="col-sm-6">
                      ...
                      <div class="col-sm-6">
                          <div class="form-group">
                              ...
                              <input type="number" class="form-control" id="inputEmail3" placeholder="Enter NID Number" value="{{ old('nid')}}" name="national_id">                            
                          </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-sm-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inputEmail3" placeholder="Name" value="{{ old('name')}}" name="name">                            
                          </div>
                      </div>
                      <div class="col-sm-6">
                          <div class="form-group">
                              <label for="inputEmail3" class="col-form-label">Birth Certificate</label>                          
                              <input type="text" class="form-control" id="inputEmail3" placeholder="Enter Birth Certificate Number" value="{{ old('birth_ctf_number')}}" name="birth_certificate_no">
                          </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-sm-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inputEmail3" placeholder="Enter Father's Name" value="{{ old('f_name')}}" name="fathers_name">
                      ...
                      <div class="col-sm-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="inputEmail3" placeholder="Enter Mother's Name" value="{{ old('m_name')}}" name="mothers_name">
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        ...
                        <div class="input-group">                          
                          <input type="text" class="form-control" id="inputEmail3" placeholder="Enter Father's Name" value="{{ old('f_name')}}" name="date_of_birth">
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                          <div class="form-group">
                            ...
                            <textarea class="form-control" rows="3" placeholder="Enter Permanent Address" name="permanent_address">{{ old('pe_address')}}</textarea>
                      ...
                      <div class="col-sm-6">
                          <div class="form-group">
                            ...
                            <textarea class="form-control" rows="3" placeholder="Enter Present Address" name="present_address">{{ old('pr_address')}}</textarea>
