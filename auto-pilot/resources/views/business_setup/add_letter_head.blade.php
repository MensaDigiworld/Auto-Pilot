          ...
          <div class="col-lg-8 col-8">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Add Letter Head</h3>
                <a href="{{ route('latterheads.index')}}" class="card-title float-right btn-success btn">List of Letter Head</a>
                
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" method="post" action="{{route('latterheads.store')}}">
                @csrf
                <div class="card-body">
                  <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                          <label for="inputEmail3" class="col-form-label">Business Name</label>                        
                            <input type="text" class="form-control" id="inputEmail3" placeholder="Enter Business Name" value="{{ old('business_name')}}" name="business_name">                          
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="inputEmail3" class="col-form-label">Branch Name</label>                        
                            <input type="text" class="form-control" id="inputEmail3" placeholder=" Enter Branch Name" value="{{ old('branch_name')}}" name="branch_name">                          
                        </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                          <label for="inputEmail3" class="col-form-label">Email</label>                        
                            <input type="email" class="form-control" id="inputEmail3" placeholder="Entar Email Address" value="{{ old('email')}}" name="email">                          
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="inputEmail3" class="col-form-label">Phone</label>                        
                            <input type="number" class="form-control" id="inputEmail3" placeholder="Enter Phone Number" value="{{ old('phone')}}" name="phone">                          
                        </div>
                    </div>
                  </div>
                  <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                              <label for="inputEmail3" class="col-form-label">BIN Number</label>                            
                                <input type="text" class="form-control" id="inputEmail3" placeholder="Enter BIN Number " value="{{ old('bin')}}" name="bin">                              
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="inputEmail3" class="col-form-label">Website</label>                            
                                <input type="url" class="form-control" id="inputEmail3" placeholder="Enter Website Address" value="{{ old('website')}}" name="website">                              
                            </div>
                        </div>
                  </div>
