          ...
          <div class="col-lg-8 col-8">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Update Branch Information</h3>
                <a href="{{ route('list-branch')}}" class="card-title float-right btn-success btn">List of Branch</a>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="{{route('branch.update', $branchs->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Branch code</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputEmail3" value="{{$branchs->code}}" name="code" placeholder="Enter your Branch code">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label"> Business Name</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputEmail3" placeholder="Enter your Business Name" value="{{$branchs->code}}" name="name">
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      ...
                      <textarea class="form-control" rows="3" placeholder="Addresss" name="address">{{$branchs->code}}</textarea>
                    </div>
                  </div>
                  <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="number" class="form-control" id="inputEmail3" placeholder="Contact Number" name="contact_no" value="{{$branchs->contact_no}}">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Email</label>
                    <div class="col-sm-10">
                      <input type="email" class="form-control" id="inputEmail3" value="{{$branchs->email}}" placeholder="Email" name="email">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Web Address</label>
                    <div class="col-sm-10">
                      <input type="url" class="form-control" id="inputEmail3" value="{{$branchs->web_address}}" placeholder="exp www.example.com" name="web_address">
                    </div>
                  </div>
