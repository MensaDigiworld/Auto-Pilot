          ...
          <div class="col-lg-6 col-6">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Update City Information</h3>
              ...
              <form class="form-horizontal" method="post" action="{{route('city.update', $city->id)}}">
                ...
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputEmail3" value="{{ $city->name}}" name="name" placeholder="Enter City Name">
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control" name="country_id">
                        ...
                        @foreach ($country as $category)
                          <option value="{{ $category->id}}" {{ $category->id==$city->country_id ? 'Selected':'' }}>{{ $category->name }}</option>
                        @endforeach  
                      </select> 
                    </div>
                  </div>
