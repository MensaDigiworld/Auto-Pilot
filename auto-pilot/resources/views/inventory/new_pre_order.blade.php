                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-12 col-lg-12 col-md-12">
                          <div class="row">
                            <div class="col-sm-12 col-lg-7 col-md-7">
                              <div class="form-group">
                                <input type="text" class="form-control form-control-sm" readonly id="inputEmail3"  value="Honda-Grace (GM4, Hybrid EX, 1500cc, Auto, 2WD,  5 seater)" name="nid">
                              </div>
                            </div>
                            <div class="col-sm-12 col-lg-5 col-md-5">
                              <div class="form-group">
                                <input type="text" class="form-control form-control-sm" id="inputEmail3"  value="2016" name="nid" readonly>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="col-sm-12">
                          <div class="row">
                            <div class="col-sm-12 col-lg-4 col-md-4">
                              <div class="form-group">
                                <input type="text" class="form-control form-control-sm" readonly id="inputEmail3" readonly value="red" name="nid">
                              </div>
                            </div>
                            <div class="col-sm-12 col-lg-4 col-md-4">
                              <div class="form-group">
                                <input type="text" class="form-control form-control-sm" id="inputEmail3"  value="340000.00" readonly name="nid">
                              </div>
                            </div>
                            <div class="col-sm-12 col-lg-4 col-md-4">
                              <div class="form-group">
                                <input type="text" class="form-control form-control-sm" id="inputEmail3"  value="4" readonly name="nid">
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="row">
                            <div class="col-sm-12 col-lg-6 col-md-6">
                                <div class="form-group">
                                  ...
                                  <input type="number" class="form-control form-control-sm" id="loan"  value="0" name="nid">
                                </div>
                            </div>
                            <div class="col-sm-12 col-lg-6 col-md-6">
                              <div class="form-group">
