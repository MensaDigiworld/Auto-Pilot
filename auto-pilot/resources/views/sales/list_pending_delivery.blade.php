  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Pending Vehicle Delivery List</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Pending Vehicle Delivery List</li>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="text-center"><a href="" class="btn btn-sm btn-info" data-toggle="modal" data-target="#confirmed_sales"> <i class="fas fa-eye"></i></a>
                          <a href="" class="btn btn-sm btn-success" data-toggle="modal" data-target="#delivery1"><i class="far fa-paper-plane"></i></a></td>
