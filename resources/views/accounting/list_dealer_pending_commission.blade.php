  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Pending Commission</h1>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Dealer Pending Commission</li>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="text-center">
                          <a href="{{ route('accounting.new_dealer_receive_commission') }}" class="btn btn-sm btn-success"><i class="fas fa-plus"></i> Payment</a>
                        </td>
