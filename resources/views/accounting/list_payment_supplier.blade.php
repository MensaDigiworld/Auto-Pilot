  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Supplier Payment List</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{ route('accounting.new_payment_supplier') }}" class="btn btn-sm btn-primary float-right"><i class="fas fa-plus"></i> Add New Payment</a></li>
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td></td>
                        <td class="text-center">
                          <a href="" class="btn btn-sm btn-info text-xs"> <i class="fas fa-eye"></i> View</a>
                        </td>
