  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Vendor New Payment</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item"><a href="#">Accounting</a></li>
              <li class="breadcrumb-item active"><a href="#">Vendor New Payment</a></li>
          ...
          <div class="col-lg-5 col-md-5 col-sm-12">
            <div class="card">
              <div class="card-header bg-success">
                <h3 class="card-title text-lg">Vendor New Payment</h3>
              </div>
            ...
            <form action="#" class="form-horizontal" method="POST">
              ...
              <div class="card-body">
                ...
                <div class="form-group row">
                  <label for="inputEmail3" class="col-sm-2 col-form-label">Vendor Name </label>
                  <div class="col-sm-10">
                    <select class="form-control select2" name="">
                      <option>Type Vendor Name</option>
                      <option>2000</option>
                      <option>2022</option>
          ...
          <div class="col-lg-7 col-md-7 col-sm-12">
            ...
            <div class="card">
              ...
              <div class="card-footer">
                ...
                <button type="submit" class="btn btn-success col-sm-12 col-lg-2 col-md-2 float-right"> <i class="fas fa-money-check-alt"></i> Payment</button>               
              </div>
            </div>
