          ...
          <div class="col-lg-8 col-8">
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Add Membership Program</h3>
                <a href="{{ route('memberships.index')}}" class="card-title float-right btn-success btn">List of Membership Program</a>                
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" method="post" action="{{route('memberships.store')}}">
                @csrf
                <div class="card-body">
                  <div class="form-group">
                    <label for="inputEmail3" class="col-form-label">Program Name</label>
                    <div class="col-sm-12">
                      <input type="text" class="form-control" id="inputEmail3" placeholder="Enter Program Name" required name="title" value="{{ old('title')}}">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputEmail3" class="col-form-label">Details</label>
                    <div class="col-sm-12">
                      <textarea class="form-control" rows="3" placeholder="" name="details">{{ old('details')}}</textarea>
                    </div>
                  </div>
                  <div class="row">
                        <div class="col-sm-6">
