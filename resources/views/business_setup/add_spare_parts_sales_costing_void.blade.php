  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Spare Parts Sales/Invoice Edit/Void</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Spare Parts Sales/Invoice Edit/Void</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-lg-7 col-md-7 col-sm-12">
            ...
            <div class="card card-info">
              <div class="card-header bg-dark">
                <h3 class="card-title h3 text-bold pt-2">Spare Parts Sales/Invoice Edit/Void</h3>
