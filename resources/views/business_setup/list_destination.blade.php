  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Destination List</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">List of Destination</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="col-lg-9 col-9">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <h3 class="card-title col-md-4">List of Destination </h3>

                <a href="{{ route('add-destination')}}" class="card-title float-right btn-success btn col-md-3"><i class="fas fa-plus"></i> Add Destination</a>
