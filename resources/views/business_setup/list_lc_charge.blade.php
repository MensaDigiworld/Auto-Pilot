          ...
          <div class="col-lg-9 col-9">
            ...
            <div class="card">
              <div class="card-header">
                ...
                <h3 class="card-title col-md-4">List of LC Charge Account List</h3>

                <a href="{{ route('add-lc-charge')}}" class="card-title float-right btn-success btn col-md-3"><i class="fas fa-plus"></i> Add LC Charge Account</a>
                <div class="input-group input-group-md float-right col-md-5">
                  <input type="text" class="form-control" placeholder="Search LC Charge">
