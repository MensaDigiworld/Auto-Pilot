  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Customer Communication</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Customer Communication</li>
            ...
            <div class="row">
              ...
              <div class="col-sm-12 col-lg-3 col-md-3">
                <div class="form-group">
                  <div class="row">
                    <div class="col-12">
                      <label for="inputEmail3" class="col-form-label">Birthday Today</label>
                    </div>
                  </div>
                ...
                <div class="col-sm-12 col-lg-3 col-md-3">
                  <div class="form-group">
                    <label for="inputEmail3" class="col-form-label">Purchase Year</label>               
                ...
                <div class="col-sm-12 col-lg-3 col-md-3">
                  <div class="form-group">
                    <label for="inputEmail3" class="col-form-label">Purchase Month</label>               
                      <select class="form-control select2" name="">
                        <option selected>Select</option>
                        <option>Pending</option>
                        <option>Active</option>
              ...
              <div class="card">
                <div class="row py-3">
                  <div class="col-lg-6 col-md-6 col-sm-12 text-lg text-success">Customer List</div>
                  <div class="col-lg-6 col-md-6 col-sm-12 d-flex justify-content-end">
                    <div class="text-md text-danger mx-1">Action: </div>
                    <i class="fas fa-envelope btn btn-sm btn-success mx-1"> Send a Mail</i> 
                            
                    <i class="fab fa-facebook-messenger btn btn-sm btn-primary"> Send SMS</i> 
                  </div>
                </div>
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          <div class="d-flex flex-column justify-centent-center">
                            <a href="{{ route('sales.add_loan_information')}}" class="btn btn-sm btn-primary flex-fill"><i class="fas fa-eye "></i> View</a>
                            <a href="{{ route('sales.add_loan_information')}}" class="btn btn-sm btn-success flex-fill"><i class="fas fa-edit "></i> Edit</a>
                          </div>
                        </td>
