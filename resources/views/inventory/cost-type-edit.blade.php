  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Update Cost Type</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Update New Cost Type</li>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-6 col-md-6 col-sm-12">
            ...
            <div class="card">
              <div class="card-body">
                <form action="{{ route('inventory.cost_type_update') }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="form-group form-group-sm row">
                      ...
                      <div class="col-sm-12 col-lg-10 col-md-10">
                        <input type="text" class="form-control form-control-sm" id="inputEmail3" placeholder="Enter Name" value="{{ $costType->name }}" name="name">
                      </div>
