              ...
              <form action="" method="POST" enctype="multipart/form-data" class="form-horizontal">
                ...
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12">
                      <div class="form-group">
                        <label for="inputEmail3" class="col-form-label">Year of Manufacture
                        </label>
                          <div class="input-group">
                              
                            <select class="form-control select2" name="manufacture">
                              <option>Select Product</option>
                              <option>2000</option>
                              <option>2022</option>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12">
                      <div class="form-group">
                        <label for="inputEmail3" class="col-form-label">Registration No</label>
                          <div class="input-group">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-6  pt-lg-4 mt-lg-3  float-right">
                    ...
                    <div class="col-lg-2 col-md-2 col-sm-6  pt-4 mt-lg-3">
                      <div class="icheck-primary d-inline">
                  ...
                  <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12">
                      <div class="form-group">
                        <label for="inputEmail3" class="col-form-label">Submitted To</label>
                          <div class="input-group">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12">
                      <div class="form-group">
                        <label for="inputEmail3" class="col-form-label">Valuation</label>
                          <div class="input-group">
                ...
                <div class="card-footer text-center">
                  ...
                  <button type="submit" class="btn btn-primary"><i class="fas fa-envelope"></i> Email</button>
