        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{ route('lclocalpurchase.store') }}" class="form-horizontal" method="POST">
                @csrf
                <div class="card-body">
                    @if ($errors->any())
                ...
                @endif
                    ...
                    <div class="col-sm-12 col-lg-4 col-md-4">
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="date" class="form-control form-control-sm" id="inputEmail3" placeholder="Enter Purchase Date" value="" name="date">
                    ...
                    <div class="col-sm-12 col-lg-4 col-md-4">
                      <label for="inputEmail3" class="col-form-label">Supplier Type <span class="text-danger fw-600">*</span></label>
                        <div class="form-group pt-2">
                              ...
                              <input type="radio" name="supplier_type" checked="" value="Organization" id="radioSuccess11">
                              <label for="radioSuccess11">
                                Organization
                              </label>
                              </div>
                              <div class="icheck-success d-inline">
                              <input type="radio" name="supplier_type" id="radioSuccess12" value="Individual">
                              <label for="radioSuccess12">
                                Individual
                              </label>
                              </div>
                              <div class="icheck-success d-inline">
                              <input type="radio" name="supplier_type" id="radioSuccess13" value="Goverment">
                              <label for="radioSuccess13">
                                Goverment
                              </label>
                              </div>
                              <div class="icheck-success d-inline">
                              <input type="radio" name="supplier_type" id="radioSuccess14" value="Customer">
                  ...
                  <div class="row">
                    <div class="col-sm-12 col-lg-4 col-md-4">
                        <div class="form-group">
                          ...
                          <div class="input-group input-group-sm">
                            <input type="number" class="form-control form-control-sm" id="invoice_number"  name="invoice_number" placeholder="Innvoice Number Auto Generate">
                            <div class="input-group-append">
                    ...
                    <div class="col-sm-12 col-lg-4 col-md-4">
                      <label for="inputEmail3" class="col-form-label">Purchase Mode <span class="text-danger fw-600">*</span></label>
                        <div class="form-group pt-2">
                              <div class="icheck-success d-inline">
                              <input type="radio" name="purchase_mode" checked="" value="" id="radioSuccess15">
                              <label for="radioSuccess15">
                                Purchase
                              </label>
                              </div>
                              <div class="icheck-success d-inline">
                              <input type="radio" name="purchase_mode" id="radioSuccess16" value="">
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group input-group-sm">
                          <select class="form-control select2" name="customer_id" required>
                            ...
                            <option value="1">Akbar Ali</option>
                            <option value="2">Arman Ai</option>
                          </select>
                          <div class="input-group-append">
                   ...
                   <div class="col-sm-12 col-lg-4 col-md-4 customer_table_hide" style="display:none;">
                    ...
                    <div class="col-sm-12 col-lg-4 col-md-4">
                      <label for="inputEmail3" class="col-form-label">Source of Product</label>
                        <div class="form-group">
                              ...
                              <div class="icheck-success d-inline">
                              <input type="radio" name="purchase_source" checked="" value="Pre_Order" id="radioSuccess3">
                              <label for="radioSuccess3">
                                Pre Order
                              </label>
                              </div>
                              <div class="icheck-success d-inline">
                              <input type="radio" name="purchase_source" id="radioSuccess4" value="Without_Pre_Order">
                    ...
                    <div class="col-sm-12 col-lg-4 col-md-4">
                      <div class="form-group">
                        ...
                        <textarea class="form-control form-control-sm" rows="1" placeholder="" name="remarks" spellcheck="false"></textarea>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-8 col-lg-6 col-md-6 pt-lg-2">
                        ...
                        <div class="form-group">
                              ...
                              <div class="icheck-success d-inline">
                              <input type="radio" name="vehicle_condition" checked="" value="Recondition" id="Recondition">
                              <label for="Recondition">
                                Recondition
                              </label>
                              </div>
                              <div class="icheck-success d-inline">
                              <input type="radio" name="vehicle_condition" id="BrandNew" value="BrandNew">
                              <label for="BrandNew">
                                Brand New
                              </label>
                              </div>
                              <div class="icheck-success d-inline">
                                <input type="radio" name="vehicle_condition" id="Used" value="Used">
                                <label for="Used">
                                  Used
                                </label>
                                </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-12 col-lg-4 col-md-4">
                          <div class="form-group">
                              ...
                              <input type="number" class="form-control form-control-sm" id="inputEmail3" placeholder="Enter Vin/Chassis No"  name="vin_chassis_no">
                          ...
                          <div class="col-sm-6 col-lg-3 col-md-3">
                              <div class="form-group">
                                  ...
                                  <input type="number" class="form-control form-control-sm" id="inputEmail3" placeholder="Enter Engine No"  name="engine_number">
                          ...
                          <div class="col-sm-6 col-lg-3 col-md-3">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control form-control-sm" id="inputEmail3" placeholder="Enter Vehicle Tracking Code"  name="vehicle_tracking_id">
                        ...
                        <div class="col-sm-12 col-lg-4 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control form-control-sm" id="inputEmail3" placeholder="Enter Mileage"  name="mileage">
                        ...
                        <div class="col-sm-12 col-lg-4 col-md-4 auction_grade">
                          <div class="form-group">
                              ...
                              <input type="number" class="form-control form-control-sm" id="inputEmail3" placeholder="Enter Auction Grade"  name="auction_grade">
                        ...
                        <div class="col-sm-12 col-lg-4 col-md-4">
                          <div class="form-group">
                              ...
                              <input type="number" class="form-control form-control-sm" id="inputEmail3" placeholder="Enter Tyre Size"  name="tyre_size">
                    ...
                    <div class="row used" style="display: none">
                      <div class="col-sm-12 col-lg-3 col-md-3">
                        <div class="form-group">
                            ...
                            <div class="form-group pt-2">
                              ...
                              <div class="icheck-success d-inline">
                              <input type="radio" name="document_status"  value="Updated" id="Updated">
                              <label for="Updated">
                                Updated
                              </label>
                              </div>
                              <div class="icheck-success d-inline">
                              <input type="radio" name="document_status" id="Failed" value="Failed">
                              <label for="Failed">
                                Failed
                              </label>
                              </div>
                      ...
                      <div class="col-sm-12 col-lg-3 col-md-3">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control form-control-sm" id="inputEmail3"  name="fitness_expiry_date">
                      ...
                      <div class="col-sm-12 col-lg-3 col-md-3">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control form-control-sm" id="inputEmail3"  name="tax_token_expiry_date">
                      ...
                      <div class="col-sm-12 col-lg-3 col-md-3">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control form-control-sm" id="inputEmail3"  name="insurance_expiry_date">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-6 col-lg-3 col-md-3 pt-lg-2">
                                ...
                                <div class="icheck-success d-inline">
                                <input type="checkbox" name="warranty" value="yes" id="radioSuccess6">
                      ...
                      <div class="col-sm-12 col-lg-8 col-md-8">
                        <div class="form-group">
                            ...
                            <textarea class="form-control form-control-sm" rows="2" placeholder="Vehicle Warranty Information" name="vehicle_description" autocomplete="on" spellcheck="false"></textarea>
                  ...
                  <div class="form-group row warrenty" style="display: none">
                    ...
                    <div class="col-sm-10">
                      ...
                      <textarea class="form-control form-control-sm" rows="3" placeholder="Addresss" name="warranty_information"></textarea>
                    </div>
                  </div>
                  ...
                  <h3>Pricing Information</h3>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-12 col-lg-4 col-md-3">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control form-control-sm" id="inputEmail3" value="0" name="price">
                        ...
                        <div class="col-sm-12 col-lg-8 col-md-3">
                          <div class="form-group">
                              ...
                              <input type="text" class="form-control form-control-sm" id="inputEmail3" value="" name="price_remarks">
                    ...
                    <div class="col-sm-12 col-lg-3 col-md-3">
                      <div class="form-group">
                          ...
                          <input type="number" class="form-control form-control-sm" id="tempsaleprice" value="0" name="temporary_sales_price">
                      ...
                      <div class="col-sm-12 col-lg-3 col-md-3">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control form-control-sm" id="tempdealerdiscount"  name="temporary_dealer_discount">
                        ...
                        <div class="col-sm-12 col-lg-3 col-md-3">
                          <div class="form-group">
                              ...
                              <input type="number" class="form-control form-control-sm" id="tempdealerprice" value="0" name="temporary_dealer_price" readonly>
