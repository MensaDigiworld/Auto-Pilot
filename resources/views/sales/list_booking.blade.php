                ...
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>2100000.00</td>
                      <td class="text-center"><a href="{{ route('sales.booking') }}" class="btn btn-sm btn-info" data-toggle="modal" data-target="#confirmed_sales"> <i class="fas fa-check"></i> Sales</a>
                          <a href="{{ route('sales.booking') }}" class="btn btn-sm btn-primary"><i class="fas fa-eye"></i> View</a></td>
