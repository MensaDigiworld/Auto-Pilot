  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Customer Loan Manager List</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Customer Loan Manager List</li>
              <li class="breadcrumb-item active"></li>
              <li class="breadcrumb-item active"><a href="{{ route('sales.new_loan_information') }}" class="btn btn-sm btn-success"><i class="fas fa-plus"></i> Add New Loan information</a></li>
            </ol>
                ...
                <table class="table table-bordered">
                  <thead>
                    <tr>
                      ...
                      <th>Product </th>
                      <th>Customer Name</th>
                      <th>Loan Processing Agent</th>
                      <th>Bank</th>
                      <th>Expected Sanction Date</th>
                      <th>Actual Sanction Date</th>
