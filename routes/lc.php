...
Route::group(['middleware' => ['auth'],'prefix' =>'Lc-Purchase'], function(){
  ...
  Route::get('/new-local-purchase', [Lcpurchase::class, 'new_local_purchase'])->name('lc.new-local-purchase');

  Route::get('/incomplete-local-purchase', [Lcpurchase::class, 'incomplete_local_purchase'])->name('lc.in-local-purchase');
